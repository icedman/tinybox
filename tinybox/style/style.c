...
void
to_lower_string(char *str, char *out)
{
...
typedef void
parse_func(int argc, char **argv, void *target, char *name);
...
int
getPropertyIndex(struct style_property *props, char *name)
{
  for (int i = 0;; i++) {
...
void
parseValue(int argc, char **argv, void *target, char *name)
{
...
void
parseInt(int argc, char **argv, void *target, char *name)
{
...
void
parseString(int argc, char **argv, void *target, char *name)
{
  if (argc < 2) {
    return;
  }
...
void
parseColor(int argc, char **argv, void *target, char *name)
{
  uint32_t color;
