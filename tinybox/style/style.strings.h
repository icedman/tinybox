style->menu_frame_font,
style->menu_frame_pixmap,
style->menu_hilite_pixmap,
style->menu_hilite_selected_pixmap,
style->menu_hilite_submenu_pixmap,
style->menu_hilite_unselected_pixmap,
style->menu_selected_pixmap,
style->menu_submenu_pixmap,
style->menu_title_font_effect,
style->menu_title_font,
style->menu_title_pixmap,
style->menu_unselected_pixmap,
style->menuFont,
style->slit_pixmap,
style->titleFont,
style->toolbar_button_pixmap,
style->toolbar_button_pressed_pixmap,
style->toolbar_clock_font,
style->toolbar_clock_pixmap,
style->toolbar_font,
...
style->toolbar_label_pixmap,
style->toolbar_pixmap,
style->toolbar_windowLabel_pixmap,
style->toolbar_workspace_font,
style->toolbar_workspace_pixmap,
style->window_close_pixmap,
style->window_close_pressed_pixmap,
style->window_close_unfocus_pixmap,
style->window_font_effect,
style->window_font,
