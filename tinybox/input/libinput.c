...
static bool
config_libinput_pointer(struct libinput_device *device,
...
void
configure_libinput_device(struct tbx_input_device *device)
{
...
static bool
reset_libinput_pointer(struct libinput_device *device, const char *device_id)
{
...
static bool
reset_libinput_keyboard(struct libinput_device *device, const char *device_id)
{
...
static bool
reset_libinput_switch(struct libinput_device *device, const char *device_id)
{
...
static bool
reset_libinput_touch(struct libinput_device *device, const char *device_id)
{
...
void
reset_libinput_device(struct tbx_input_device *device)
{
